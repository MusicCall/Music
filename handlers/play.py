...
@Client.on_message(
    command("play") & ~filters.edited & ~filters.bot & ~filters.private
)
@authorized_users_only
        ...
        keyboard = InlineKeyboardMarkup(
            [
                [
                    ...
                    InlineKeyboardButton("📣 ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/L9L9L")
                ],
            ]
        )
        file_name = get_file_name(audio)
        title = file_name
        thumb_name = "https://telegra.ph/file/81f10f739947b05d02c4c.jpg"
