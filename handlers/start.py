...
💭 **[{BOT_NAME}](https://t.me/{BOT_USERNAME}) اهلا بك في بوت تشغيل الاغاني بالمكالمه**
        ...
        reply_markup=InlineKeyboardMarkup(
            [ 
                [
                    ...
                    InlineKeyboardButton(
                        "📣 قناة سورس", url=f"https://t.me/{UPDATES_CHANNEL}")               
                 ],[
                    InlineKeyboardButton(
                        "🧪", url="https://t.me/L9L9L"
                    )
                ]
            ]
        ),
...
async def help(client: Client, message: Message):
    await message.reply_text(
        f"""<b>☢ ʜᴇʟʟᴏ {message.from_user.mention()}, اضغط لمعرفة تشغيل البوت</b>""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        text="✔ كيفية استخدام البوت", url=f"https://t.me/{BOT_USERNAME}?start=help"
                    )
                ]
            ]
        )
...
/gcast - send a broadcast message trought the assistant
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    InlineKeyboardButton(
                        "♞🏻‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ", url=f"https://t.me/L9L9L"
                    )
                ]
            ]
        )
